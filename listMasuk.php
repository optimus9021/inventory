                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        masuk.qty, masuk.keterangan, masuk.tanggal
                                        FROM masuk
                                        JOIN item ON masuk.idbarang = item.idbarang 
                                        JOIN supplier ON masuk.idsupplier = supplier.idsupplier"
                                        );
    ...
    <div class="modal fade" id="myModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <button type="submit" class="btn btn-primary" name="addnewin">Submit</button>
            </div>
            </form>
            </div>
        </div>
