                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        "SELECT supplier.namasupplier,
                                        item.namabarang, item.harga
                                        FROM item                                        
                                        JOIN supplier ON item.idsupplier = supplier.idsupplier"
                                        );
    ...
    <div class="modal fade" id="myModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" name="namabarang" placeholder="Masukkan Nama Produk" class="form-control" required>
                <br>
                ...
                <br>
                <input type="number" name="harga" placeholder="Masukkan Harga" class="form-control" min="0" required>
                <br>
